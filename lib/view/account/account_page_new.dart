...
import 'package:stormaviator/view/account/logout.dart';
import 'package:stormaviator/view/account/service_center/custmor_service.dart';
import 'package:stormaviator/view/account/service_center/setting_page_new.dart';
import 'package:stormaviator/view/account/transction_history.dart';
        ...
        children: [
          Stack(
            children: [
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: height * 0.22, left: width * 0.025),
                child: Column(
                  children: [
                    Container(
                      height: height * 0.2,
