...
import 'package:stormaviator/model/promotion_commission_model.dart';
...
class _CommissionDetailsState extends State<CommissionDetails> {
  ...
  Future<void> commissionDetailsApi() async {
    ...
    final response = await http.get(
      Uri.parse('${ApiUrl.CommissionDetailApi}$token&subtypeid=23&date=$_selectedDate'),
    );
    if (kDebugMode) {
